...
const BASE_URL = `https://v6.exchangerate-api.com/v6/a2c25d715f6144ca0cbd13ab/latest`;
...
const updateExchangeRate = async () => {
    ...
    let result = (amtVal * exchangeRate).toFixed(2);
...
document.getElementById("arrow").addEventListener("click", (evt) => {
    evt.preventDefault();
    swapCurrencies();
});
